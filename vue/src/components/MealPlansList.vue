...
<div id="meal-plan-display">
    ...
    <div class="meal-plans">
      ...
      <div id="meal-plan-card">
        ...
        <router-link id="link-to-detail" :to="{ name: 'meal-plan-details', params: { mealPlanId: mealPlan.mealPlanId } }">Meal Plan Details</router-link>
      </div>
      </div>
    </div>
</div>
...
.meal-plan{/*the dark grey transparent box*/
  border-radius: 6px;
  padding: 1rem;
  margin: 10px;
  display:flex;
